...
public class WinScene {
    public static void load() {
        ...
        //大鸟吃小鸟
        Label birdLabel = new Label("游戏胜利");
        birdLabel.setLayoutX(340);
        birdLabel.setLayoutY(100);
        birdLabel.setStyle("-fx-font-size:60px; -fx-text-fill:RED");
        root.getChildren().add(birdLabel);
        //添加按钮
        Button StartButton = new Button("重新开始");
